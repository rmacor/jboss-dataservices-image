...
import org.infinispan.online.service.endpoint.MemcachedTester;
...
public class CachingServiceTest {
   ...
   MemcachedTester memcachedTester = new MemcachedTester();
   ...
   @Test
   public void should_read_and_write_through_memcached_endpoint() {
      memcachedTester.putGetRemoveTest(memcachedService);
   }
